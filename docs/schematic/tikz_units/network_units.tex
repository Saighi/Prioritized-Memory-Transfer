...
% ---- nodes ----
\node[error] (eS1) at (0.00,-0.00) {$\varepsilon_{S,1}$};
\node[value] (xS1) at (0.00,-2.62) {$x_{S,1}$};
\node[error] (eTS1) at (0.00,-5.25) {$\varepsilon_{TS,1}$};
\node[value] (xT1) at (0.00,-7.88) {$x_{T,1}$};
\node[error] (eT1) at (0.00,-10.50) {$\varepsilon_{T,1}$};
\node[error] (eS2) at (5.20,-0.00) {$\varepsilon_{S,2}$};
\node[value] (xS2) at (5.20,-2.62) {$x_{S,2}$};
\node[error] (eTS2) at (5.20,-5.25) {$\varepsilon_{TS,2}$};
\node[value] (xT2) at (5.20,-7.88) {$x_{T,2}$};
\node[error] (eT2) at (5.20,-10.50) {$\varepsilon_{T,2}$};
...
\draw[err, inhib] (xS1) to[bend left=16.0] (eTS1);
\draw[pred, excit] (eTS1) to[bend left=16.0] node[glab, pos=0.5]{$\pi_{TS}$} (xS1);
\draw[pred, excit] (xT1) to[bend left=16.0] (eTS1);
\draw[pred, excit] (eTS1) to[bend left=16.0] node[glab, pos=0.5]{$\kappa$} (xT1);
...
\draw[err, inhib] (xS2) to[bend left=16.0] (eTS2);
\draw[pred, excit] (eTS2) to[bend left=16.0] node[glab, pos=0.5]{$\pi_{TS}$} (xS2);
\draw[pred, excit] (xT2) to[bend left=16.0] (eTS2);
\draw[pred, excit] (eTS2) to[bend left=16.0] node[glab, pos=0.5]{$\kappa$} (xT2);
...
\draw[pred, excit] (eT1) to[bend left=10] node[glab, pos=0.18]{$\pi_T W_{T,12}$} (xT2);
\draw[err, inhib] (xS2) to[bend left=10] node[glab, pos=0.18]{$W_{S,12}$} (eS1);
\draw[pred, excit] (eS1) to[bend left=10] node[glab, pos=0.18]{$\pi_S W_{S,12}$} (xS2);
\draw[err, inhib] (xT1) to[bend left=10] node[glab, pos=0.18]{$W_{T,21}$} (eT2);
\draw[pred, excit] (eT2) to[bend left=10] node[glab, pos=0.18]{$\pi_T W_{T,21}$} (xT1);
\draw[err, inhib] (xS1) to[bend left=10] node[glab, pos=0.18]{$W_{S,21}$} (eS2);
\draw[pred, excit] (eS2) to[bend left=10] node[glab, pos=0.18]{$\pi_S W_{S,21}$} (xS1);

% ---- population captions ----
\node[font=\small\bfseries, gray, anchor=east] at (-1.10,-1.31) {STUDENT\,S};
\node[font=\small\bfseries, gray, anchor=east] at (-1.2,-5) {INTERFACE};
\node[font=\small\bfseries, gray, anchor=east] at (-1.6,-5.5) {ERROR};

\node[font=\small\bfseries, gray, anchor=east] at (-1.10,-9.19) {TEACHER\,T};
