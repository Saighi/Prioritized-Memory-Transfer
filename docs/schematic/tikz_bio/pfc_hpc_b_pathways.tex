...
\node[note, anchor=center] at (0.00,-8.05) { two descending routes, one net effect: suppression of CA1 principal cells.\\[1pt]the ascending route is direct and excitatory. the model writes the teacher's search gain as $\kappa>0$. };
