...
% ---- captions ----
\node[note, anchor=center] at (0.00,-6.35) { the receiver suppresses the source it also learns from:\\[1pt]in the model, an interface drive of reversed sign ($\pi_{ST}<0$) };
