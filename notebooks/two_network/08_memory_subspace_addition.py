# %% [markdown]
# # Sum of memory subspaces — single run & dynamics
#
# On student connected to two teacher transfer the sum of their subspaces
# This phenomenon should not be called synthesis in this linear scenario
# %% imports & path setup
import os
import sys
import pathlib
